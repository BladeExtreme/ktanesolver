...
class friendship(edgework):
    ...
    __colexplanation = {
        'amethyst star': '3 diamonds, magenta background', 'apple cinnamon': 'green apple and a cinnamon, dark red background', 'apple fritter': '3 cracker/fritters, yellow background', 'babs seed': 'scissor with red handle', 'berryshine': 'grape and apple', 'big mcintosh': 'half green apple, red background', 'bulk biceps': 'dumbell', 'candace': 'blue diamond heart, magenta background', 'golden harvest': 'three carrots, yellow background', 'celestia': 'orange sun with 8 spiral rays', 'cheerilee': 'three flower with white petals. dark purple background', 'cheese sandwich': 'bread being half torned in the middle, with cheese in the middle', 'cherry jubilee': 'two cherry', 'coco pommel': 'purple hat with red feather on its back',
