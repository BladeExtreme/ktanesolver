...
class wordsearch(edgework):
    ...
    def __check(self, l):
        if not isinstance(l, list): raise TypeError("cornerletters must be in list")
        elif any([True if not isinstance(a, str) else False for a in l]): raise TypeError("Elements of cornerletters must be in str")
    ...
    def __init__(self, edgework:edgework, cornerletters:list):
        '''
    ...
    def __calculate(self):
        ...
        ans = []
        print(len(self.__wordlist), len(self.__letpos))
